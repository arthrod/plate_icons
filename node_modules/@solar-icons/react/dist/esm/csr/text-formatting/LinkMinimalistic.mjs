...
var m = (t, i, e) => i in t ? n(t, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : t[i] = e, o = (t, i) => {
  for (var e in i || (i = {}))
...
import w from "../../defs/text-formatting/LinkMinimalistic.mjs";
const L = d((t, i) => /* @__PURE__ */ p.createElement(k, r(o({ ref: i }, t), { weights: w })));
L.displayName = "LinkMinimalistic";
export {
  L as default
};
