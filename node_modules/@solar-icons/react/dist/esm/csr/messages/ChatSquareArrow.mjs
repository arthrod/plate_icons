...
var t = (e, r, a) => r in e ? i(e, r, { enumerable: !0, configurable: !0, writable: !0, value: a }) : e[r] = a, m = (e, r) => {
  ...
  if (o)
    for (var a of o(r))
      w.call(r, a) && t(e, a, r[a]);
  return e;
}, f = (e, r) => p(e, s(r));
import d, { forwardRef as h } from "react";
import l from "../../lib/IconBase.mjs";
import n from "../../defs/messages/ChatSquareArrow.mjs";
const u = h((e, r) => /* @__PURE__ */ d.createElement(l, f(m({ ref: r }, e), { weights: n })));
u.displayName = "ChatSquareArrow";
export {
  u as default
};
